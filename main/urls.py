...
from main.views import EmployeeListAPIView, EmployeeDetailAPIView, CategoryListAPIView, CategoryDetailAPIView, \
    ...
    CustomerCardDetailAPIView, CheckListAPIView, CheckDetailAPIView, StoreProductListAPIView, StoreProductDetailsAPIView
...
urlpatterns = [
    ...
    path('customers/<str:card_number>/', CustomerCardDetailAPIView.as_view(), name='customer-card-detail'),
    ...
    path('store_products/<str:pk>/', StoreProductDetailsAPIView.as_view(), name='store-product-detail')
]
