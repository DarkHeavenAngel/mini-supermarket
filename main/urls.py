...
from main.views import EmployeeListAPIView, EmployeeDetailAPIView, CategoryListAPIView, CategoryDetailAPIView, \
    ProductListAPIView, ProductDetailAPIView, EmployeeProfileAPIView, CustomerCardListAPIView, \
...
urlpatterns = [
    ...
    path('customers/<int:customer_card>/', CustomerCardDetailAPIView.as_view(), name='customer-card-detail'),
    path('checks/', CheckListAPIView.as_view(), name='check-list'),
    path('checks/<int:check>/', CheckDetailAPIView.as_view(), name='check-detail'),
    path('store_products/', StoreProductListAPIView.as_view(), name='store-product-list'),
    path('store_products/<int:store_product_id>/', StoreProductListAPIView.as_view(), name='store-product-detail')
]
